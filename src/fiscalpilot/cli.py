...
def _connect_quickbooks_interactive(sandbox: bool = False, port: int = 8080) -> None:
    ...
    try:
        ...
        console.print("Tokens saved to: [bold]~/.fiscalpilot/tokens/quickbooks.json[/bold]")
        console.print()
        console.print("Add to fiscalpilot.yaml:")
        console.print("[dim]connectors:")
        console.print("  - type: quickbooks")
        console.print("    credentials:")
        console.print(f"      client_id: {client_id}")
        console.print("      client_secret: <YOUR_SECRET>")
...
def _connect_xero_interactive(port: int = 8080) -> None:
    ...
    try:
        ...
        console.print("Tokens saved to: [bold]~/.fiscalpilot/tokens/xero.json[/bold]")
        console.print()
        console.print("Add to fiscalpilot.yaml:")
        console.print("[dim]connectors:")
        console.print("  - type: xero")
        console.print("    credentials:")
        console.print(f"      client_id: {client_id}")
        console.print("      client_secret: <YOUR_SECRET>")
...
def _connect_square_interactive(sandbox: bool = False) -> None:
    ...
    typer.prompt("Access Token", hide_input=True)
    ...
    console.print("Add to fiscalpilot.yaml:")
    console.print("[dim]connectors:")
    console.print("  - type: square")
    console.print("    credentials:")
    console.print("      access_token: <YOUR_TOKEN>")
    if location_id:
...
def _connect_plaid_interactive(sandbox: bool = False, port: int = 8080) -> None:
    ...
    try:
        ...
        console.print("Tokens saved to: [bold]~/.fiscalpilot/tokens/plaid.json[/bold]")
        console.print()
        console.print("Add to fiscalpilot.yaml:")
        console.print("[dim]connectors:")
        console.print("  - type: plaid")
        console.print("    credentials:")
        console.print(f"      client_id: {client_id}")
        console.print("      secret: <YOUR_SECRET>")
...
def _save_report(report, output: str) -> None:  # noqa: ANN001
    """Save report to file."""
    path = Path(output)
    content = report.to_json() if path.suffix == ".json" else report.to_markdown()
